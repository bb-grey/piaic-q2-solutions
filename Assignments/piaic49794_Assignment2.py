...
def function5():
    ...
    z = np.zeros((4, 5), dtype=np.uint8) #wrtie your code here
...
def function9():
    ...
    a = np.arange(2, 101, step=2) # write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans1 = np.dstack((arr, arr, arr)).reshape(-1)
...
def function15():
    ...
    ans = arr.sort(axis=0) #write your code here 
